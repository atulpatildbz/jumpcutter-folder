...
parser.add_argument('--frame_margin', type=float, default=2, help="Make this 0 for the jumpiest footage, around 1 for normal, 2 if you're having some sounds cut out unintentionally, and >3 if you want it very smooth.")
...
for file in allListOfVideoFiles:
    if ".mp4" in file:
        listOfVideoFiles.append(root.folderName+'/'+file)
...
if len(listOfVideoFiles)==0:
    quit()

for file in listOfVideoFiles:
    INPUT_FILE = file
